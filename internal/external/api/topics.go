...
func (c *Client) FetchTopics() ([]entities.Topic, error) {
...
func (c *Client) FetchTopicPosts(slug string, limit int) ([]entities.Post, string, error) {
...
func (c *Client) FetchMoreTopicPosts(slug string, limit int, cursor string) ([]entities.Post, string, error) {
